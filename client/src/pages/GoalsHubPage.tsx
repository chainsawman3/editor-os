                ...
                {sectionProjects.map((p) => {
                  ...
                  return (
                    <div
                      ...
                      className="bg-zinc-950 border border-zinc-800 hover:border-zinc-700 rounded-xl p-4.5 cursor-pointer group transition-all flex flex-col justify-between space-y-4 hover:shadow-md"
                    >
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-1.5">
                            <span className="px-2 py-0.5 text-[9px] font-mono rounded bg-cyan-950 border border-cyan-800/80 text-cyan-300 font-bold uppercase">
                              {p.status}
                            </span>
                      ...
                      <div className="space-y-2 pt-2 border-t border-zinc-900">
                        ...
                        {p.client_name && (
                          <div className="text-[11px] font-mono text-zinc-400 truncate">
                            👤 Client: <span className="text-zinc-200">{p.client_name}</span>
                          </div>
                        )}
                        <div className="flex items-center justify-between text-[11px] font-mono text-zinc-400 pt-1">
                          ...
                          <span className="flex items-center gap-1 text-zinc-300 font-bold group-hover:text-white">
